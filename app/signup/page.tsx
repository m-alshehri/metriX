  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-50 px-6">
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-soft">
        <Link href="/" className="text-3xl font-extrabold text-metrix-900">metriX</Link>
        <h1 className="mt-8 text-4xl font-extrabold">إنشاء حساب</h1>
        ...
        <div className="mt-7 space-y-4">
          ...
          <button className="w-full rounded-2xl bg-metrix-900 px-4 py-3 font-semibold text-white">إنشاء الحساب</button>
        </div>
      </div>
    </main>
  );
