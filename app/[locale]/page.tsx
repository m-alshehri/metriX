    ...
    <main className="overflow-hidden bg-white">
      <section className="relative border-b border-zinc-100">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 pb-20 pt-20 lg:grid-cols-[1.05fr_.95fr] lg:pb-28 lg:pt-24">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#660066]/15 bg-[#660066]/5 px-4 py-2 text-sm font-extrabold tracking-[.08em] text-[#660066]">
              <Sparkles size={15} />
              {copy.eyebrow}
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="#request-demo" className="inline-flex items-center gap-2 rounded-full bg-[#330033] px-6 py-3.5 text-base font-extrabold text-white transition hover:bg-[#660066]">
                {copy.demo} <ArrowRight size={17} className={ar ? "rotate-180" : ""} />
              </a>
              <a href={`/${locale}/login`} className="rounded-full border border-zinc-300 bg-white px-6 py-3.5 text-base font-extrabold text-zinc-800 transition hover:border-[#660066] hover:text-[#660066]">
                {copy.login}
              </a>
            </div>
          </div>
            ...
            <div className="rounded-[2rem] border border-zinc-200 bg-white p-4 shadow-[0_30px_90px_rgba(51,0,51,0.14)]">
              <div className="rounded-[1.5rem] bg-zinc-50 p-5">
                ...
                <div className="mt-5 grid grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={label} className="rounded-2xl border border-zinc-200 bg-white p-4">
                      ...
                      <div className="mt-1 text-[12px] font-extrabold text-emerald-600">{delta}</div>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-4 grid gap-3 md:grid-cols-[1.2fr_.8fr]">
                  ...
                  <div className="rounded-2xl border border-zinc-200 bg-white p-4">
                    <div className="text-sm font-extrabold">{ar ? "المشاعر" : "Sentiment"}</div>
                    <div className="mt-5 space-y-4">
                      <div>
                        <div className="flex justify-between text-[13px] font-semibold"><span>{ar ? "إيجابي" : "Positive"}</span><span>68%</span></div>
                        <div className="mt-1.5 h-2 rounded-full bg-zinc-100"><div className="h-full w-[68%] rounded-full bg-emerald-500" /></div>
                      </div>
                      <div>
                        <div className="flex justify-between text-[13px] font-semibold"><span>{ar ? "محايد" : "Neutral"}</span><span>23%</span></div>
                        <div className="mt-1.5 h-2 rounded-full bg-zinc-100"><div className="h-full w-[23%] rounded-full bg-zinc-400" /></div>
                      </div>
                      <div>
                        <div className="flex justify-between text-[13px] font-semibold"><span>{ar ? "سلبي" : "Negative"}</span><span>9%</span></div>
        ...
        <div className="mx-auto max-w-7xl px-6 pb-12">
          <p className="text-center text-sm font-extrabold uppercase tracking-[.16em] text-zinc-400">{copy.trusted}</p>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {[
            ...
            <article key={title} className="rounded-[2rem] border border-zinc-200 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
              ...
              <h2 className="mt-6 text-3xl font-extrabold tracking-[-0.03em]">{title}</h2>
      ...
      <section id="solutions" className="bg-zinc-950 py-24 text-white">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-2">
          <div>
            <div className="text-sm font-extrabold uppercase tracking-[.18em] text-fuchsia-300">{copy.alerts}</div>
            <h2 className="mt-4 text-5xl font-extrabold tracking-[-0.045em] sm:text-6xl">{copy.neverMiss}</h2>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-5 shadow-2xl">
            <div className="rounded-[1.4rem] bg-white p-5 text-zinc-900">
              ...
              <div className="mt-5 rounded-2xl bg-zinc-50 p-5">
                <div className="text-sm font-semibold text-zinc-400">{ar ? "ارتفاع في المحادثات" : "Conversation spike detected"}</div>
                <div className="mt-2 text-4xl font-extrabold">+164%</div>
      ...
      <section id="ai" className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-24 lg:grid-cols-2">
        <div className="order-2 lg:order-1">
          <div className="rounded-[2rem] border border-zinc-200 bg-zinc-50 p-5">
            <div className="rounded-[1.4rem] bg-white p-5 shadow-sm">
              <div className="flex items-center gap-2 font-extrabold text-[#660066]"><BrainCircuit size={20} /> AI Insights</div>
              <div className="mt-5 space-y-3">
                {[
                  ...
                  <div key={x} className="flex gap-3 rounded-2xl border border-zinc-100 bg-zinc-50 p-4">
                    <span className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#660066] text-sm font-extrabold text-white">{i + 1}</span>
                    <p className="text-base font-medium leading-6 text-zinc-700">{x}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="order-1 lg:order-2">
          <div className="inline-flex items-center gap-2 text-sm font-extrabold uppercase tracking-[.18em] text-[#660066]"><Sparkles size={16} /> AI intelligence</div>
          <h2 className="mt-4 text-5xl font-extrabold tracking-[-0.045em] sm:text-6xl">{copy.aiTitle}</h2>
      ...
      <section id="sources" className="border-y border-zinc-200 bg-zinc-50 py-20">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <h2 className="mt-5 text-5xl font-extrabold tracking-[-0.04em]">{copy.sources}</h2>
      ...
      <section id="request-demo" className="scroll-mt-28 bg-white py-24">
        <div className="mx-auto grid max-w-7xl items-start gap-12 px-6 lg:grid-cols-[.9fr_1.1fr]">
          <div className="lg:pt-10">
            <div className="inline-flex items-center gap-2 rounded-full bg-[#660066]/8 px-4 py-2 text-sm font-extrabold text-[#660066]">
              <MessageCircleMore size={16} />
              {copy.demo}
            </div>
            <h2 className="mt-5 text-5xl font-extrabold tracking-[-0.045em] sm:text-6xl">{copy.demoTitle}</h2>
