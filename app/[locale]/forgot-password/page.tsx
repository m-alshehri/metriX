      ...
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-soft">
        ...
        {searchParams?.message === "check-email" && (
          <div className="mt-5 rounded-2xl bg-emerald-50 p-4 text-base text-emerald-800">
            {ar
              ? "تم إرسال رابط الاستعادة. افتح أحدث رسالة وصلتك إلى بريدك الإلكتروني."
              : "Recovery link sent. Open the newest email in your inbox."}
          </div>
        )}
        {searchParams?.error && (
          <div className="mt-5 rounded-2xl bg-red-50 p-4 text-base text-red-800">
            {searchParams.error === "expired"
              ...
              : ar
                ...
                : "We couldn't send the recovery link. Please try again."}
          </div>
        )}
        ...
        <Link
          href={`/${locale}/login`}
          className="mt-5 block text-center text-base text-metrix-900 hover:underline"
        >
