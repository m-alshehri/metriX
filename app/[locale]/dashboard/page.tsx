      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-4xl tracking-tight text-[#330033]">
          ...
          <div className="flex gap-2">
            ...
            <form action={signOut}>
              ...
              <button className="rounded-full border border-zinc-300 bg-white px-5 py-2.5 text-base text-zinc-700">
                {t.dashboard.logout}
              </button>
            </form>
          </div>
        ...
        <div className="mt-10 flex items-center justify-between">
          <h2 className="text-2xl ">{t.dashboard.projectsTitle}</h2>
          <span className="rounded-full bg-white px-3 py-1 text-sm text-zinc-500 shadow-sm ring-1 ring-zinc-200">
