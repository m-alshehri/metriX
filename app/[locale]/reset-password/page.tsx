    ...
    >
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-soft">
        ...
        <h1 className="mt-8 text-4xl ">
          {ar ? "تعيين كلمة مرور جديدة" : "Choose a new password"}
        </h1>
        {!user ? (
          <>
            <div className="mt-5 rounded-2xl bg-amber-50 p-4 text-base text-amber-900">
              {ar
            ...
            <Link
              ...
              className="mt-5 block text-center text-metrix-900 hover:underline"
            >
          ...
          <>
            <p className="mt-3 text-base text-zinc-600">
              {ar
                ? "اكتب كلمة المرور الجديدة مرتين للتأكيد."
            ...
            <form action={updatePassword} className="mt-7 space-y-4">
              ...
              <button className="w-full rounded-2xl bg-metrix-900 px-4 py-3 text-white">
                {ar ? "حفظ كلمة المرور" : "Save new password"}
              </button>
            </form>
          </>
        )}
