  ...
  return (
    <section id="alert-settings" className="mt-10">
      <div className="rounded-[2rem] border bg-white p-6 shadow-sm">
        ...
        {status === "saved" && (
          <div className="mt-5 rounded-2xl bg-emerald-50 px-4 py-3 text-base text-emerald-700">
        ...
        <form action={saveAlertSettings} className="mt-6 space-y-6">
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="rounded-full bg-metrix-900 px-6 py-3 text-white transition hover:opacity-90"
            >
