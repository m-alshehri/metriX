...
export default function DashboardPreview({t}:{t:any}){
 ...
 <div className="mb-5 flex items-center justify-between"><div><p className="text-sm uppercase tracking-[0.2em] text-metrix-700">Dashboard</p><h3 className="mt-1 text-2xl ">{t.dashboardPreview.title}</h3></div><div className="rounded-full bg-white px-3 py-2 text-sm text-zinc-500">{t.dashboardPreview.period}</div></div>
